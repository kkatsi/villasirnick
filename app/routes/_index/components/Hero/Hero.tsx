...
const Hero: React.FC<AnchorHTMLAttributes<HTMLAnchorElement>> = (props) => {
  return (
    <Link
      to="#content"
      className="container sticky top-1/2 lg:py-[15dvh] transform -translate-y-1/2 h-[100dvh] flex justify-center items-center"
      {...props}
    >
      <div className="bg-transparent text-black w-full h-full p-2 lg:grid lg:grid-cols-2">
        <div className="relative flex flex-col justify-center items-center gap-2 p-12 lg:p-24">
